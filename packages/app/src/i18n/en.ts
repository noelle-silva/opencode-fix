export const dict = {
  ...
  "command.selection.ask": "Ask about selection",
  "command.selection.ask.description": "Open the floating prompt for selected session text",
  ...
  "selection.ask.placeholder": "Ask about this selection...",
  "selection.ask.submit": "Ask",
  ...
  "selection.answer.selectedText": "Selected text",
  "selection.answer.question": "Question",
  "selection.answer.pending": "Waiting for the answer...",
  ...
  "settings.tab.wallpapers": "Wallpapers",
  ...
  "settings.general.row.sidebarPosition.description": "Choose which side the desktop sidebar appears on",
  "settings.general.row.sidebarPosition.option.left": "Left",
  "settings.general.row.sidebarPosition.option.right": "Right",
  ...
  "settings.storage.description":
    "Choose where OpenCode stores local sessions, snapshots, authentication, and database files.",
  "settings.storage.section.current": "Current location",
  "settings.storage.section.move": "Move storage",
  "settings.storage.row.active.title": "Active data directory",
  "settings.storage.row.active.description": "OpenCode is currently reading and writing data here.",
  "settings.storage.row.database.title": "Database file",
  "settings.storage.row.database.description": "SQLite database used for sessions, messages, and project records.",
  "settings.storage.row.default.title": "Default data directory",
  "settings.storage.row.default.description": "The location OpenCode uses when no custom directory is configured.",
  "settings.storage.row.custom.title": "Custom data directory",
  "settings.storage.row.custom.description":
    "Pick an empty folder. Choose copy if you want existing data moved into the new folder first.",
  "settings.storage.action.copy": "Copy path",
  "settings.storage.action.choose": "Choose folder",
  "settings.storage.action.chooseCopy": "Choose and copy",
  "settings.storage.action.restart": "Restart now",
  "settings.storage.picker.title": "Choose data storage folder",
  "settings.storage.toast.copied.title": "Path copied",
  "settings.storage.toast.saved.title": "Storage location saved",
  "settings.storage.toast.saved.description": "Restart OpenCode to use the new data location.",
  "settings.storage.toast.reset.title": "Storage reset to default",
  "settings.storage.toast.failed.title": "Storage update failed",
  "settings.storage.webHint": "Data storage can only be changed from the desktop app or CLI.",
  "settings.wallpapers.title": "Wallpapers",
  "settings.wallpapers.description": "Choose local images, frame them with drag and wheel zoom, adjust opacity and blur, then switch between saved wallpaper instances.",
  "settings.wallpapers.section.library": "Wallpaper library",
  "settings.wallpapers.section.editor": "Frame wallpaper",
  "settings.wallpapers.row.active.title": "Active wallpaper",
  "settings.wallpapers.row.active.description": "Add a local image or disable the current wallpaper.",
  "settings.wallpapers.action.add": "Choose image",
  "settings.wallpapers.action.disable": "Disable",
  "settings.wallpapers.action.save": "Save wallpaper",
  "settings.wallpapers.status.active": "Active",
  "settings.wallpapers.empty": "No wallpapers saved yet.",
  "settings.wallpapers.desktopOnly": "Wallpapers can only be managed from the desktop app.",
  "settings.wallpapers.picker.title": "Choose wallpaper image",
  "settings.wallpapers.toast.saved.title": "Wallpaper saved",
  "settings.wallpapers.toast.failed.title": "Wallpaper image could not be loaded",
  "settings.wallpapers.editor.ariaLabel": "Wallpaper framing preview",
  "settings.wallpapers.editor.hint": "Drag to move the image. Use the mouse wheel to zoom.",
  "settings.wallpapers.editor.opacity": "Opacity",
  "settings.wallpapers.editor.blur": "Blur",
  "settings.wallpapers.fit.cover": "Cover",
  "settings.wallpapers.fit.contain": "Contain",

  "settings.ephemeralContexts.title": "Temporary context",
  "settings.ephemeralContexts.description":
    "Create request-only message presets that are sent to the model without being saved in the session history.",
  "settings.ephemeralContexts.section.presets": "Context presets",
  "settings.ephemeralContexts.section.editor": "Edit preset",
  "settings.ephemeralContexts.row.active.title": "Active context preset",
  "settings.ephemeralContexts.row.active.description": "Choose which preset is selected by default in the prompt input.",
  "settings.ephemeralContexts.action.add": "New preset",
  "settings.ephemeralContexts.action.disable": "Disable",
  "settings.ephemeralContexts.action.addMessage": "Add message",
  "settings.ephemeralContexts.action.moveUp": "Move up",
  "settings.ephemeralContexts.action.moveDown": "Move down",
  "settings.ephemeralContexts.status.active": "Active",
  "settings.ephemeralContexts.empty": "No temporary context presets saved yet.",
  "settings.ephemeralContexts.toast.saved": "Temporary context saved",
  "settings.ephemeralContexts.toast.empty": "Add at least one message before saving.",
  "settings.ephemeralContexts.preset.messages": "{{count}} request-only messages",
  "settings.ephemeralContexts.editor.name": "Preset name",
  "settings.ephemeralContexts.editor.group": "Preset group",
  "settings.ephemeralContexts.group.ungrouped": "Ungrouped",
  "settings.ephemeralContexts.editor.description": "Description",
  "settings.ephemeralContexts.editor.messages": "Messages",
  "settings.ephemeralContexts.message.title": "Message title",
  "settings.ephemeralContexts.message.role": "Role",
  "settings.ephemeralContexts.message.position": "Position",
  "settings.ephemeralContexts.message.content": "Content",
  "settings.ephemeralContexts.role.system": "System",
  "settings.ephemeralContexts.role.user": "User",
  "settings.ephemeralContexts.role.assistant": "Assistant",
  ...
  "settings.ephemeralContexts.position.inside_user_top": "Inside latest user top",
  "settings.ephemeralContexts.position.inside_user_bottom": "Inside latest user bottom",
