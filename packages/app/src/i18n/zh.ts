...
export const dict = {
  ...
  "command.selection.ask": "对所选文字提问",
  "command.selection.ask.description": "为会话中选中的文字打开浮动提问框",
  ...
  "selection.ask.placeholder": "针对这段选中文字提问...",
  "selection.ask.submit": "提问",
  ...
  "selection.answer.selectedText": "选中文字",
  "selection.answer.question": "问题",
  "selection.answer.pending": "正在等待回答...",
  ...
  "settings.tab.storage": "数据存储",
  "settings.tab.wallpapers": "壁纸",
  ...
  "settings.general.row.fontSize.title": "界面字体大小",
  "settings.general.row.fontSize.description": "调整整个界面中文字的大小",
  ...
  "settings.general.row.sidebarPosition.title": "侧边栏位置",
  "settings.general.row.sidebarPosition.description": "选择桌面侧边栏显示在左侧还是右侧",
  "settings.general.row.sidebarPosition.option.left": "左侧",
  "settings.general.row.sidebarPosition.option.right": "右侧",
  ...
  "settings.storage.description": "选择 OpenCode 存放本地会话、快照、认证信息和数据库文件的位置。",
  "settings.storage.section.current": "当前位置",
  "settings.storage.section.move": "迁移存储",
  "settings.storage.row.active.title": "当前数据目录",
  "settings.storage.row.active.description": "OpenCode 当前正在这里读写数据。",
  "settings.storage.row.database.title": "数据库文件",
  "settings.storage.row.database.description": "用于保存会话、消息和项目记录的 SQLite 数据库。",
  "settings.storage.row.default.title": "默认数据目录",
  "settings.storage.row.default.description": "没有配置自定义目录时，OpenCode 会使用这个位置。",
  "settings.storage.row.custom.title": "自定义数据目录",
  "settings.storage.row.custom.description": "请选择一个空文件夹；如果想把现有数据带过去，请选择复制。",
  "settings.storage.action.copy": "复制路径",
  "settings.storage.action.choose": "选择文件夹",
  "settings.storage.action.chooseCopy": "选择并复制",
  "settings.storage.action.restart": "立即重启",
  "settings.storage.picker.title": "选择数据存储文件夹",
  "settings.storage.toast.copied.title": "路径已复制",
  "settings.storage.toast.saved.title": "存储位置已保存",
  "settings.storage.toast.saved.description": "重启 OpenCode 后会使用新的数据位置。",
  "settings.storage.toast.reset.title": "存储位置已恢复默认",
  ...
  "settings.wallpapers.row.active.description": "添加本地图片，或关闭当前壁纸。",
  "settings.wallpapers.action.add": "选择图片",
  "settings.wallpapers.action.disable": "关闭壁纸",
  "settings.wallpapers.action.save": "保存壁纸",
  "settings.wallpapers.status.active": "使用中",
  "settings.wallpapers.empty": "还没有保存壁纸。",
  "settings.wallpapers.desktopOnly": "壁纸只能在桌面应用中管理。",
  "settings.wallpapers.picker.title": "选择壁纸图片",
  "settings.wallpapers.toast.saved.title": "壁纸已保存",
  ...
  "settings.ephemeralContexts.title": "临时上下文",
  "settings.ephemeralContexts.description": "创建只在请求时发送给模型、不会保存进会话历史的消息预设。",
  "settings.ephemeralContexts.section.presets": "上下文预设",
  "settings.ephemeralContexts.section.editor": "编辑预设",
  "settings.ephemeralContexts.row.active.title": "当前上下文预设",
  "settings.ephemeralContexts.row.active.description": "选择输入框默认使用的临时上下文预设。",
  "settings.ephemeralContexts.action.add": "新建预设",
  "settings.ephemeralContexts.action.disable": "关闭",
  "settings.ephemeralContexts.action.addMessage": "添加消息",
  "settings.ephemeralContexts.action.moveUp": "上移",
  "settings.ephemeralContexts.action.moveDown": "下移",
  "settings.ephemeralContexts.status.active": "使用中",
  "settings.ephemeralContexts.empty": "还没有保存临时上下文预设。",
  "settings.ephemeralContexts.toast.saved": "临时上下文已保存",
  "settings.ephemeralContexts.toast.empty": "保存前请至少添加一条消息。",
  "settings.ephemeralContexts.preset.messages": "{{count}} 条请求期消息",
  "settings.ephemeralContexts.editor.name": "预设名称",
  "settings.ephemeralContexts.editor.group": "预设分组",
  "settings.ephemeralContexts.group.ungrouped": "未分组",
  "settings.ephemeralContexts.editor.description": "描述",
  "settings.ephemeralContexts.editor.messages": "消息",
  "settings.ephemeralContexts.message.title": "消息标题",
  "settings.ephemeralContexts.message.role": "角色",
  "settings.ephemeralContexts.message.position": "位置",
  "settings.ephemeralContexts.message.content": "内容",
  "settings.ephemeralContexts.role.system": "系统",
  "settings.ephemeralContexts.role.user": "用户",
  "settings.ephemeralContexts.role.assistant": "AI",
  ...
  "settings.ephemeralContexts.position.inside_user_top": "最新用户消息内部顶部",
  "settings.ephemeralContexts.position.inside_user_bottom": "最新用户消息内部尾部",
