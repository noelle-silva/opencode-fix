...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  return (
    <div class="relative size-full _max-h-[320px] flex flex-col gap-0">
        ...
        >
          ...
          >
            <div
              ...
              classList={{
                "select-text": true,
                "w-full min-h-[126px] pl-3 pr-2 pt-2 text-14-regular text-text-strong focus:outline-none whitespace-pre-wrap":
                  true,
          ...
          <div class="pointer-events-none absolute bottom-2 left-2 right-12 flex items-center gap-1.5 min-w-0">
            <div
            ...
            <Show when={isDesktop() && store.mode === "normal"}>
              <div
                data-component="prompt-inline-controls"
                class="flex items-center gap-1.5 min-w-0 max-w-full overflow-hidden pointer-events-auto"
              >
                <SelectionControls />
              </div>
            </Show>
      ...
      <Show when={store.mode === "shell" || !isDesktop()}>
        <DockTray attach="top">
