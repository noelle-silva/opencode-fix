    ...
    >
      ...
      <Kobalte.Portal>
        <Kobalte.Content
          ...
          class="w-72 h-80 flex flex-col p-2 rounded-md border border-border-base bg-surface-raised-stronger-non-alpha shadow-md z-[80] outline-none overflow-hidden"
